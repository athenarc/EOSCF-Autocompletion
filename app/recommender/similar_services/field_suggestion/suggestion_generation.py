...
def get_auto_complete_suggestions(new_service, requested_fields, maximum_suggestions=5, existing_fields_values=None,
    ...
    for requested_field in requested_fields:
        ...
        field_suggestions = get_candidates(field_values=similar_services[similar_services["service_id"]
                                           .isin(similar_services_ids_per_field[requested_field])][requested_field]
                                           .values.tolist(),
                                           frequency_threshold=APP_SETTINGS["BACKEND"]["AUTO_COMPLETION"]
