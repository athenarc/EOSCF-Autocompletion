...
CONFIG_DIR = \
    "app/recommender/similar_services/service_recommendation/evaluation/" \
    "manual_evaluation/recommender_version_distances/configs/best_metadata_attributes/"
...
HEATMAP_STORAGE_FILE = \
    'app/recommender/similar_services/service_recommendation/evaluation/manual_evaluation/' \
    'recommender_version_distances/storage/results/heatmap.png'
...
def plot_pairwise_similarities(dissimilarities_matrix, variations_names=None):
    ...
    sns.heatmap(dissimilarities_matrix,
                ...
                vmin=0, vmax=1, annot=True, mask=mask)
